...
static void test_sort_found_pokemon(void);
...
static void test_add_pokemon(void) {
    ...
    printf("    ...Counting how many pokemon in Pokedex\n");
    assert(count_total_pokemon(pokedex) == 1);
    
    printf("    ... Adding more Pokemon to the Pokedex\n");
...
static void test_next_pokemon(void) {
    ...
    /*printf("    ... Checking this is empty Pokedex\n");
    assert(pokedex == NULL);*/
    ...
    printf("       --> Checking that the current Pokemon is still Venusaur\n");
    assert(is_same_pokemon(get_current_pokemon(pokedex), venusaur));
...
static void test_sort_found_pokemon(void) {
    ...
    printf("    ... Adding them into Pokedex\n");
    add_pokemon(pokedex, venusaur);
    add_pokemon(pokedex, bulbasaur);
    add_pokemon(pokedex, ivysaur);

    printf("    ... Sorting them in ascending order\n");
    sort_found_pokemon(pokedex);

    printf("    ... Checking Pokemon in ascengding order\n");
    assert(is_same_pokemon(get_current_pokemon(pokedex), bulbasaur));
    next_pokemon(pokedex);
    assert(is_same_pokemon(get_current_pokemon(pokedex), ivysaur));
    next_pokemon(pokedex);
    ...
    printf(">> Passed sort_found_pokemon tests!\n");
}
...
static void test_prev_pokemon(void) {
    ...
    printf("    ... Moving to next Pokemon\n");
    next_pokemon(pokedex);

    printf("       --> Checking that the current Pokemon is Bulbasaur\n");
    assert(is_same_pokemon(get_current_pokemon(pokedex), bulbasaur));

    printf("    ... Moving to previous Pokemon\n");
...
static void test_change_current_pokemon(void) {
    ...
    printf("    ... Moving to the Pokemon that ID is 2\n");
